...
public class RechercheSimilariteImage2 {
	 ...
	 */
	public RechercheSimilariteImage2(Signature objetImage,float tauxDeSimilarite){
		super();
	...
	public void listerRepertoire() {
		...
		for (i = 0; i < listefichiers.length; i++) {
			if (listefichiers[i].endsWith(".txt") == true) {
				...
				CalculSimilariteObd2 calculSimilariteObd = new CalculSimilariteObd2(objetImage, lectureSignature);
